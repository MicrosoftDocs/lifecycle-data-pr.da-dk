...
ms.locfileid: "885786"
---
# <a name="export"></a><span data-ttu-id="2f411-103">Eksportfil</span><span class="sxs-lookup"><span data-stu-id="2f411-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="2f411-104">Denne side er under udvikling.</span><span class="sxs-lookup"><span data-stu-id="2f411-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="2f411-105">Eksportér alle produkter</span><span class="sxs-lookup"><span data-stu-id="2f411-105">Export All Products</span></span>
<span data-ttu-id="2f411-106">Eksportér alle produkter uden filtre.</span><span class="sxs-lookup"><span data-stu-id="2f411-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="2f411-107">Eksportér alle produkter</span><span class="sxs-lookup"><span data-stu-id="2f411-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="2f411-108">Eksportere produkter efter kategori</span><span class="sxs-lookup"><span data-stu-id="2f411-108">Export Products by Category</span></span>
<span data-ttu-id="2f411-109">Vælg en gruppering, der skal eksporteres:</span><span class="sxs-lookup"><span data-stu-id="2f411-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="2f411-167">Eksportér produkter ved afslutning af support året</span><span class="sxs-lookup"><span data-stu-id="2f411-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="2f411-168">Vælg et år for at eksportere produkter, der afslutter tjenesten i det pågældende år:</span><span class="sxs-lookup"><span data-stu-id="2f411-168">Select a year to export products ending service in that year:</span></span>
